            ...
            <form id="myform" name="myform" autocomplete="off">
                ...
                <div id="Form3">
                    ...
                    <div style ="display: flex;">
                        ...
                        <input style ="width: 50%;" type="text" id="dobtext" maxlength="10"  placeholder="DOB DD/MM/YYYY" autocomplete="off" />
                        </div>
                    
                    <input type="text" id="nametext" maxlength="60" placeholder="NAME" autocomplete="off" />
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $('#AddRowbtn').click(function () {                    
                    ...
                    $('#FamilyDetailTable > tbody:last-child').append('<tr><td><div class="clsDelete"><i class="fas fa-trash-alt" aria-hidden="true"></i></div></td><td>' + $('#RelationDropdown option:selected').text() + '</td><td>' + $('#nametext').val() + '</td><td>' + cusdate + '</td><td>' + $('#Disabled option:selected').val() + '</td></tr>');
