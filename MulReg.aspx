<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MulReg.aspx.cs" Inherits="MulReg" %>
...
<form id="msform">
  ...
  <!-- progressbar -->
    ...
    <h2 class="content-sub-heading">Create your account</h2>
...
<ul id="progressbar">
 ...
 <div class="container">
  ...
  <div class="row">
    ...
    <div class="col-35">
      <input type="text" id="fname2" name="firstname" placeholder="Your Scdond name..">
    </div>
  ...
  <div class="row">
    ...
    <div class="col-35">
      <input type="text" id="lnameas" name="lastname" placeholder="Your last name..">
    </div>
