...
Partial Class Jct_Payroll_Common_Files_Company
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not (Page.IsPostBack) Then
            ...
            'End If
            objFun.FillList(ddlCatg, "SELECT DISTINCT NameCategory,NameCategory FROM dbo.Jct_Payroll_Fap_Item_Master WHERE STATUS='A' AND GETDATE() BETWEEN EffFrom AND EffTo ORDER BY NameCategory")
    ...
    Private Sub BindMenu()
        'Dt_EmpData = GetData("Jct_Payroll_Fap_Item_Master_Bind  '" & Session("EmpCode") & "'")
        Dt_EmpData = GetData("Jct_Payroll_Fap_Item_Master_Bind '" & ddlCatg.SelectedItem.Text & "'")
