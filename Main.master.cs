...
public partial class Main : System.Web.UI.MasterPage
{
    ...
    //{
    //    string query = "Exec Jct_Payroll_Portal_Proc1 '" + Session["Empcode"].ToString() + "',9999";
                       ...
                       sb.Append("<ul class='menu-collapse collapse' id='" + Title + "' >");
                        foreach (var item in rows)
                        {
                            ...
                            else
                            {
                                ...
                                //Added by Aslam On 6 Mar 2020(Start)
                                //if (Title == "EmployeeInfo")
                                //{
                                //    string storeval = item["Description"].ToString();
                                //    if (storeval == "Appraisal")
                                //    {
                                //        sb.Append("<li><a class='padding-right-lg waves-attach' href='" + item["page_name"] + "'>" + item["Description"] + "<img src='Image/NewItem.gif'>" + "</a>");
                                //        sb.Append("</li>");
                                //    }
                                //    else
                                //    {
                                ...
                                //Added by Aslam On 6 Mar 2020(End)
