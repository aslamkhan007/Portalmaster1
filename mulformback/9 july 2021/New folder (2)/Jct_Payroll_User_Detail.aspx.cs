...
public partial class Jct_Payroll_User_Detail : System.Web.UI.Page
{
    ...
    {        
        //nameCookie = Request.Cookies["Name"].Value; 
        ...
        //myCode = Convert.ToString(nameCookie);
    ...
    public static class MyStaticValues
    {
        ...
        //public static string myname =  "nameCookie" 
        //public static string _myString = myCode;
    ...
    public static MyViewModel GetInitialDetails()
    {
        ...
        user.CurrentAddress = CurrentAddressDetails(myCode);
        user.PermanentAddress = PermanentAddressDetails(Convert.ToString(myCode));       
        return user;
    }
