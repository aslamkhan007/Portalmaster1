            ...
            function OnSuccessGetInitialDetails(response) {                                                
                ...
                if (response.d.FamilyDetails.length > 0) {
                    for (var i = 0; i < response.d.FamilyDetails.length; i++) {
                        ...
                        $('#FamilyDetailTable').append('<tr><td>' + response.d.FamilyDetails[i].Relation + '</td><td>' + response.d.FamilyDetails[i].Name + '</td><td>' + response.d.FamilyDetails[i].dob + '</td><td><input type="button" class = "clsDelete" value="Delete Row1"></td></tr>');
                    }
                }
...
//            });
    ...
    swal("Your imaginary file is safe!");
            ...
            //$(document).on('click', '#FamilyDetailTable', function () {
