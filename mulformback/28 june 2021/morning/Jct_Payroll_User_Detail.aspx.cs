...
{         
    ...
    public class CurrentAddress
    {
        ...
        public int CurrentMobile { get; set; }
        public int CurrentSecondaryMobileNo { get; set; }        
    ...
    public class PermanentAddress
    {
        ...
        public int PermanentMobile { get; set; }
        public int PermanentSecondaryMobileNo { get; set; }
    ...
    public static void SaveUser(CurrentAddress user, PermanentAddress user1, FamilyDetails[] user2)
    {
        ...
        cmd.Parameters.Add("@PermanentPrimaryMobileNo", SqlDbType.Int).Value = Convert.ToInt32(user1.PermanentPrimaryLandline);
        cmd.Parameters.Add("@PermanentSecondaryMobileNo", SqlDbType.Int).Value = Convert.ToInt32(user1.PermanentSecondaryMobileNo);
    ...
    public static CurrentAddress CurrentAddressDetails(string names)
    {
        ...
        foreach (DataRow dtrow in dt.Rows)
        {
            ...
            CurrentAddresss.CurrentMobile = Convert.ToInt32(dtrow["CurrentPrimaryMobileNo"].ToString());
            CurrentAddresss.CurrentSecondaryMobileNo = Convert.ToInt32(dtrow["CurrentSecondaryMobileNo"].ToString());
    ...
    public static PermanentAddress PermanentAddressDetails(string names)
    {
        ...
        foreach (DataRow dtrow in dt.Rows)
        {
            ...
            PermanentAddresss.PermanentMobile = Convert.ToInt32(dtrow["PermanentPrimaryMobileNo"].ToString());
            PermanentAddresss.PermanentSecondaryMobileNo = Convert.ToInt32(dtrow["PermanentSecondaryMobileNo"].ToString());
