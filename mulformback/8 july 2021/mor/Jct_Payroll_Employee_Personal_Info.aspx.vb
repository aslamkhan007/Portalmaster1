...
Partial Class Payroll_Jct_Payroll_Employee_Personal_Info
    ...
    Protected Sub Submit(sender As Object, e As EventArgs)
        ...
        Response.Redirect(String.Format("~/Jct_Payroll_User_Detail.aspx?name={0}", name))

        'Page.ClientScript.RegisterStartupScript(this.GetType(),"OpenWindow","window.open('~/Jct_Payroll_User_Detail.aspx?name={0}','_newtab');",true);
