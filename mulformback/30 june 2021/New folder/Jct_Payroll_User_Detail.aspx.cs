...
{         
    ...
    public class CurrentAddress
    {
        ...
        public Int64 CurrentMobile { get; set; }
        public Int64 CurrentSecondaryMobileNo { get; set; }        
    ...
    public class PermanentAddress
    {
        ...
        public Int64 PermanentMobile { get; set; }
        public Int64 PermanentSecondaryMobileNo { get; set; }
    ...
    public static void SaveUser(CurrentAddress user, PermanentAddress user1, FamilyDetails[] user2)
    {
        ...
        cmd.Parameters.Add("@CurrentPrimaryMobileNo", SqlDbType.Int).Value = Convert.ToInt32(user.CurrentPrimaryLandline);
        cmd.Parameters.Add("@CurrentSecondaryMobileNo", SqlDbType.Int).Value = Convert.ToInt32(user.CurrentSecondaryMobileNo);
        ...
        cmd.Parameters.Add("@PermanentPrimaryMobileNo", SqlDbType.BigInt).Value = Convert.ToInt32(user1.PermanentPrimaryLandline);
        cmd.Parameters.Add("@PermanentSecondaryMobileNo", SqlDbType.BigInt).Value = Convert.ToInt32(user1.PermanentSecondaryMobileNo);
    ...
    public static CurrentAddress CurrentAddressDetails(string names)
    {
        ...
        foreach (DataRow dtrow in dt.Rows)
        {
            ...
            CurrentAddresss.CurrentMobile = Convert.ToInt64(dtrow["CurrentPrimaryMobileNo"].ToString());
            CurrentAddresss.CurrentSecondaryMobileNo = Convert.ToInt64(dtrow["CurrentSecondaryMobileNo"].ToString());
    ...
    public static PermanentAddress PermanentAddressDetails(string names)
    {
        ...
        foreach (DataRow dtrow in dt.Rows)
        {
            ...
            PermanentAddresss.PermanentMobile = Convert.ToInt64(dtrow["PermanentPrimaryMobileNo"].ToString());
            PermanentAddresss.PermanentSecondaryMobileNo = Convert.ToInt64(dtrow["PermanentSecondaryMobileNo"].ToString());
