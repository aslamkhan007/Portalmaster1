...
{         
    ...
    [WebMethod]
    public static void SaveUser(User[] user, User[] user1)
    {
    }
    ...
    public static MyViewModel GetInitialDetails()
    {
        ...
        user.CurrentAddress = CurrentAddressDetails();
        user.PermanentAddress = PermanentAddressDetails();
        return user;
    }

    [System.Web.Services.WebMethod]
    //public static void PostInitialDetails()
    //public static void PostInitialDetails(object user)
     //public static void PostInitialDetails()
    //public static void PostInitialDetails(User user)
    //{
    //    MyViewModel1 setuser = new MyViewModel1();
    //    //user.CurrentAddress = CurrentAddressDetails(MyStaticValues.MyStaticBool);
    //    //user.PermanentAddress = PermanentAddressDetails(MyStaticValues.MyStaticBool);       
        
    //}
    public static CurrentAddress CurrentAddressDetails()
    {
        ...
        cmd.Parameters.Add("@Employeecode", SqlDbType.VarChar, 50).Value = "9000000537";
    ...
    public static PermanentAddress PermanentAddressDetails()
    {
        DataTable dt = new DataTable();
